...
import { Slider, AiStage, SliderSuggestion, TerraformConfig, TerraformTarget, ControlConfig, SoundConfig, Modulation, CameraData, ViewMode, ShipConfig, ShipModulation, Alien, Laser, Particle } from '../types';
...
export interface AppContextType {
  ...
  score: number;
  isGameOver: boolean;
  aliensRef: MutableRefObject<Alien[]>;
  playerLasersRef: MutableRefObject<Laser[]>;
  alienLasersRef: MutableRefObject<Laser[]>;
  particlesRef: MutableRefObject<Particle[]>;
  screenShakeRef: MutableRefObject<number>;
  damageFlashRef: MutableRefObject<number>;
  triggerFireRef: MutableRefObject<boolean>;
